...
VOID InitPredictors()
{
    ...
    // push_back any other predictors here
    BTBPredictor *testBTB= new BTBPredictor(512, 1, 16);
    branch_predictors.push_back(testBTB);
	
	BTBPredictor *testBTB_2= new BTBPredictor(64, 8, 16);
    branch_predictors.push_back(testBTB_2);
	
	BTFNTPredictor *testBTFNTPredictor = new BTFNTPredictor();
	branch_predictors.push_back(testBTFNTPredictor);
	
	StaticNotTakenPredictor *testStaticNotTakenPredictor = new StaticNotTakenPredictor();
	branch_predictors.push_back(testStaticNotTakenPredictor);	
